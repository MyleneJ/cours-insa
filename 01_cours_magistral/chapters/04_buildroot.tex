...
\begin{frame}{Buildroot dans l'industrie?}
  ...
  \end{itemize}
  \column{0.4\textwidth}
  \only{\includegraphics[height=0.25\textheight]{pictures/01_cours_magistral/google-fiber-box.jpg}}\\
  \only{\includegraphics[height=0.25\textheight]{pictures/01_cours_magistral/armada.jpg}}\\
  \only{\includegraphics[height=0.25\textheight]{pictures/01_cours_magistral/raspberrypi.jpg}}
  \end{columns}
\end{frame}
